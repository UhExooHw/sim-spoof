...
/data/adb/magisk/busybox test ! -d /data/adb/modules/bindhosts/system/etc && /data/adb/magisk/busybox echo "[×] Bindhosts hosts not installed. Exiting." && exit 1
...
/data/adb/magisk/busybox wget -O /data/adb/modules/bindhosts/system/etc/hosts https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts || { /data/adb/magisk/busybox echo "[×] Failed to download hosts file."; exit 1; }
