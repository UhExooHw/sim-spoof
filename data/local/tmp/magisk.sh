...
/product/bin/resetprop -n persist.vendor.mtk.provision.mccmnc.0 "$MCCMNC,$MCCMNC"
/product/bin/resetprop -n persist.vendor.mtk.provision.mccmnc.1 "$MCCMNC,$MCCMNC"
/product/bin/resetprop -n vendor.gsm.ril.uicc.mccmnc "$MCCMNC,$MCCMNC"
/product/bin/resetprop -n vendor.gsm.ril.uicc.mccmnc.1 "$MCCMNC,$MCCMNC"
