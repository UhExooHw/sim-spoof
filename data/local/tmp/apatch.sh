...
/data/adb/ap/bin/busybox test ! -d /data/adb/service.d && /data/adb/ap/bin/busybox echo "[×] Root solution is not installed. Exiting." && exit 1
/data/adb/ap/bin/busybox test ! -d /data/adb/modules/systemless-apns && /data/adb/ap/bin/busybox echo "[×] Systemless-apns not installed. Exiting." && exit 1

CHARS="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"
SERIAL_NO=""
for i in $(/data/adb/ap/bin/busybox seq 1 12); do
...
/data/adb/ap/bin/busybox echo "Manual Input:"
/data/adb/ap/bin/busybox echo -n "Enter ISO (e.g., SC for Seychelles): "
read ISO
/data/adb/ap/bin/busybox echo -n "Enter Timezone (e.g., Europe/Moscow): "
read TZ
if [[ ! "$TZ" =~ "/" ]]; then
    /data/adb/ap/bin/busybox echo "[×] Invalid timezone format. Must contain a forward slash (e.g., Europe/Moscow)."
    exit 1
fi
...
/data/adb/ap/bin/busybox wget -O /data/adb/modules/systemless-apns/system/etc/hosts https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts
...
/data/adb/ap/bin/resetprop -n ro.cdma.home.operator.numeric "$MCCMNC,$MCCMNC"
/data/adb/ap/bin/resetprop -n ril.mcc.mnc0 "$MCCMNC,$MCCMNC"
/data/adb/ap/bin/resetprop -n ril.mcc.mnc1 "$MCCMNC,$MCCMNC"
/data/adb/ap/bin/resetprop -n persist.vendor.mtk.provision.mccmnc.0 "$MCCMNC,$MCCMNC"
/data/adb/ap/bin/resetprop -n persist.vendor.mtk.provision.mccmnc.1 "$MCCMNC,$MCCMNC"
/data/adb/ap/bin/resetprop -n vendor.gsm.ril.uicc.mccmnc "$MCCMNC,$MCCMNC"
/data/adb/ap/bin/resetprop -n vendor.gsm.ril.uicc.mccmnc.1 "$MCCMNC,$MCCMNC"
...
/data/adb/ap/bin/resetprop -n ro.com.android.dataroaming "0"
...
/data/adb/ap/bin/resetprop -n ro.serialno "$SERIAL_NO"
/data/adb/ap/bin/resetprop -n ro.boot.serialno "$SERIAL_NO"
...
/data/adb/ap/bin/resetprop -n net.wlan0.dns1 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan0.dns2 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan1.dns1 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan1.dns2 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan2.dns1 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan2.dns2 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan3.dns1 \$DNS
/data/adb/ap/bin/resetprop -n net.wlan3.dns2 \$DNS
EOF
