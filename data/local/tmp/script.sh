...
while true; do
  ...
  echo "  ${BOLD}[4]${RESET} Digitale Gesellschaft      (dns.digitale-gesellschaft.ch)"
...
case "$DNS_CHOICE" in
  ...
  4) DNS="185.95.218.43"; DNSv6="2a05:fc84::43"; DOT_HOST="dns.digitale-gesellschaft.ch"; break ;;
  5)
