...
/data/adb/ksu/bin/busybox test ! -d /data/adb/service.d && /data/adb/ksu/bin/busybox echo "[×] Root solution is not installed. Exiting." && exit 1
...
/data/adb/ksu/bin/resetprop -n persist.vendor.mtk.provision.mccmnc.0 "$MCCMNC,$MCCMNC"
/data/adb/ksu/bin/resetprop -n persist.vendor.mtk.provision.mccmnc.1 "$MCCMNC,$MCCMNC"
/data/adb/ksu/bin/resetprop -n vendor.gsm.ril.uicc.mccmnc "$MCCMNC,$MCCMNC"
/data/adb/ksu/bin/resetprop -n vendor.gsm.ril.uicc.mccmnc.1 "$MCCMNC,$MCCMNC"
