...
- 📶 Устанавливает TTL = 64, чтобы не платить за раздачуинтернетеа.
...
Выполните следующую команду в Android-терминале или через ADB:
...
&& echo "[✓] Скрипт загружен. Запустите: sh /data/local/tmp/spoof.sh"
```
